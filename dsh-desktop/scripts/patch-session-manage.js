...
// deleteSession 的 parameter/result schema；unarchive 系 schema 0.1.6 已原生）。
const REMOTES_SCHEMA_ANCHOR = 'const _deepseek_ai_dsh_api_workspace_controller_workspace_unarchiveSession_result$schema = object({ "archivedSessionIds": array(intersection(string(), unknown())).readonly() });\n\t\tconst TYPERT_REMOTE$2 = {';
const REMOTES_SCHEMA_INSERT = 'const _deepseek_ai_dsh_api_workspace_controller_workspace_unarchiveSession_result$schema = object({ "archivedSessionIds": array(intersection(string(), unknown())).readonly() });\n\t\tconst _deepseek_ai_dsh_api_workspace_controller_workspace_deleteSession_parameter_0$schema = object({ "sessionId": intersection(string(), unknown()).readonly() });\n\t\tconst _deepseek_ai_dsh_api_workspace_controller_workspace_deleteSession_result$schema = object({ "deleted": boolean().readonly() });\n\t\tconst TYPERT_REMOTE$2 = {';

// 6b. descriptor 条目（原生 unarchiveSession 描述符之后、数组闭合前插入
// deleteSession 描述符；unarchive 描述符 0.1.6 已原生，sourceLocation line 119）。
const REMOTES_INVOKE_ANCHOR = 'schema: _deepseek_ai_dsh_api_workspace_controller_workspace_unarchiveSession_result$schema\n\t\t\t\t\t},\n\t\t\t\t\tsourceLocation: {\n\t\t\t\t\t\t"file": "packages/api/workspace-controller/src/index.ts",\n\t\t\t\t\t\t"line": 119,\n\t\t\t\t\t\t"column": 3\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t]\n\t\t};';
const REMOTES_INVOKE_INSERT = 'schema: _deepseek_ai_dsh_api_workspace_controller_workspace_unarchiveSession_result$schema\n\t\t\t\t\t},\n\t\t\t\t\tsourceLocation: {\n\t\t\t\t\t\t"file": "packages/api/workspace-controller/src/index.ts",\n\t\t\t\t\t\t"line": 119,\n\t\t\t\t\t\t"column": 3\n\t\t\t\t\t}\n\t\t\t\t},\n\t\t\t\t{\n\t\t\t\t\tid: "@deepseek-ai/dsh-api-workspace-controller#workspace/deleteSession",\n\t\t\t\t\tservice: "workspaceController",\n\t\t\t\t\tnamespace: "workspace",\n\t\t\t\t\tmethod: "deleteSession",\n\t\t\t\t\tinvocation: { kind: "direct" },\n\t\t\t\t\tparameters: [{\n\t\t\t\t\t\tname: "request",\n\t\t\t\t\t\twire: "request",\n\t\t\t\t\t\tsource: "json",\n\t\t\t\t\t\tcodec: {\n\t\t\t\t\t\t\tmode: "strict",\n\t\t\t\t\t\t\ttypeSymbol: "@deepseek-ai/dsh-api-workspace-controller/types#WorkspaceDeleteSessionRequest",\n\t\t\t\t\t\t\tschema: _deepseek_ai_dsh_api_workspace_controller_workspace_deleteSession_parameter_0$schema\n\t\t\t\t\t\t}\n\t\t\t\t\t}],\n\t\t\t\t\tresult: {\n\t\t\t\t\t\tmode: "strict",\n\t\t\t\t\t\ttypeSymbol: "@deepseek-ai/dsh-api-workspace-controller/types#WorkspaceDeleteSessionValue",\n\t\t\t\t\t\tschema: _deepseek_ai_dsh_api_workspace_controller_workspace_deleteSession_result$schema\n\t\t\t\t\t},\n\t\t\t\t\tsourceLocation: {\n\t\t\t\t\t\t"file": "packages/api/workspace-controller/src/index.ts",\n\t\t\t\t\t\t"line": 999,\n\t\t\t\t\t\t"column": 3\n\t\t\t\t\t}\n\t\t\t\t}\n\t\t\t]\n\t\t};';
